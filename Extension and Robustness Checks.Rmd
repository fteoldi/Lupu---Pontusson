...
twoyear2 <- panelAR(socspend ~ ma2_pratio9050s + ma2_pratio5010s +gdpgrowth + as.factor(id), data=data2yr_socspend , panelVar='id', timeVar='time', autoCorr='psar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
summary(twoyear2)
