...
```{r}
# Social spending moving average (var20)
data$ma_socspend <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# pratio9050s moving average (var)
data$ma_pratio9050s <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# pratio5010s moving average (var)
data$ma_pratio5010s <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5
  
# ratio9010s moving average (var)
data$ma_pratio9010s <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# skews moving average (var)
data$ma_skews <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# dreher moving average (var)
data$ma_dreher <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# pop65 moving average (var)
data$ma_pop65 <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# stdpjoint moving average (var)
data$ma_stdpjoint <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# stddisp_gall moving average (var)
data$ma_stddisp_gall <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# fempar moving average (var)
data$ma_fempar <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# unempl moving average (var)
data$ma_unempl <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# union moving average (var)
data$ma_union <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# turnout moving average (var)
data$ma_turnout <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# pvoc moving average (var)
data$ma_pvoc <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5

# fpop moving average (var)
data$ma_fpop <- lag(data[,20], 1)+lag(data[,20], 2)+lag(data[,20], 3)+lag(data[,20], 4)+lag(data[,20], 5)/5
...
```{r}
out1 <- panelAR(redist ~ redist.lag + dvpratio9050 + dvpratio5010 + dvturnout + dvfempar + dvpropind + dvpvoc + dvunion + dvunempl, data=redistsample, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out1))
```
...
out2 <- panelAR(redist ~ redist.lag + dvpratio9050 + dvpratio5010 + dvturnout + dvfempar + dvpropind + dvpvoc + dvunion + dvunempl, data=redistsample_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out2))
```
...
#Specification 9: 
```{r}
out9 <- panelAR(socspend ~ socspend.lag + mapratio9050s + mapratio5010s + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher + gdpgrowth, data=data, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out9))
```
...
out10 <- panelAR(socspend ~ socspend.lag + mapratio9050s + mapratio5010s + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher + gdpgrowth, data=data_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out10))
```

# Specification 11 (no controls)
```{r}
out11 <- panelAR(socspend ~ mapratio9050s + mapratio5010s +gdpgrowth + as.factor(id), data=data, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out11))
```
...
out12 <- panelAR(socspend ~ mapratio9050s + mapratio5010s +gdpgrowth+ as.factor(id), data=data_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out12))
```

#Specification 13 (Using skew as main inequality measure)
```{r}
out13<- panelAR(socspend ~ socspend.lag + maratio9010s + maskews + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher + gdpgrowth, data=data, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out13))
```
...
out14<- panelAR(socspend ~ socspend.lag + maratio9010s + maskews + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher + gdpgrowth, data=data_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out14))
```

#Specification 15 (Skew as main measure, no controls, country fixed effects)
```{r}
out15 <- panelAR(socspend ~ maratio9010s + maskews +gdpgrowth+ as.factor(id), data=data, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out15))	
```
...
out16 <- panelAR(socspend ~ maratio9010s + maskews +gdpgrowth + as.factor(id), data=data_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out16))	
```
...
```{r}
out17 <- panelAR(redist ~ redist.lag + dvskew + dvturnout + dvfempar + dvpropind + dvpvoc + dvunion + dvunempl +mafpop, data=redistsample, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out17))
```
...
out18 <- panelAR(redist ~ redist.lag + dvskew + dvturnout + dvfempar + dvpropind + dvpvoc + dvunion + dvunempl +mafpop, data=redistsample_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out18))
```
#Specification 19 (Social spending as main DV, adding dvfpop)
```{r}
out19<- panelAR(socspend ~ socspend.lag + maratio9010s + maskews + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher +mafpop + gdpgrowth, data=data, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out19))
...
#creating a new subset without these observations
redistsample_noout<- out19$model[index,]

#running same model as spec19 with new subset
out20<- panelAR(socspend ~ socspend.lag + maratio9010s + maskews + mapop65+ maturnout + mafempar + mastdisp_gall + mapvoc + maunion + maunempl + madreher +mafpop + gdpgrowth, data=data_noout, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out20))
```
...
out21<- panelAR(stdpjoint~maskews + mastddisp_gall + maturnout , data=recentyears, panelVar='id', timeVar='time', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out21))
#Specification 22 (Adding globalization)
out22<- panelAR(stdpjoint~maskews + mastddisp_gall + maturnout +madreher , data=recentyears, panelVar='id', timeVar='time', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE) 
print(summary(out22))
...
```{r}
out27 <- panelAR(redist ~ redist.lag + dvskew + dvturnout + dvfempar + dvpropind + dvpvoc + dvunion + dvunempl +dvfpop +dvstdpjoint, data=redistsample, panelVar='id', timeVar='time', autoCorr='ar1', panelCorrMethod='pcse',rho.na.rm=TRUE, panel.weight='t-1', bound.rho=TRUE)
print(summary(out27))
```
