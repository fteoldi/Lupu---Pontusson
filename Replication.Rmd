...
data[,46] <- case_when(
   ...
   data$since ==  2 ~ data[,37],
   data$since ==  3 ~ data[,38],
   data$since ==  4 ~ data[,39],
   data$since ==  5 ~ data[,40],
   data$since ==  6 ~ data[,41],
   data$since ==  7 ~ data[,42],
   data$since ==  8 ~ data[,43],
   data$since ==  9 ~ data[,44],
   data$since ==  10 ~ data[,45]
)

# Calculate moving average for pratio9050 
...
data[,57] <- case_when(
   ...
   data$since ==  2 ~ data[,37+11],
   data$since ==  3 ~ data[,38+11],
   data$since ==  4 ~ data[,39+11],
   data$since ==  5 ~ data[,40+11],
   data$since ==  6 ~ data[,41+11],
   data$since ==  7 ~ data[,42+11],
   data$since ==  8 ~ data[,43+11],
   data$since ==  9 ~ data[,44+11],
   data$since ==  10 ~ data[,45+11]
)

# Calculate moving average for pratio5010 

# Calculate moving average for stdpjoint 

# Calculate moving average for skew 

# Calculate moving average for stddisp_gall 

# Calculate moving average for pvoc 

# Calculate moving average for union 

# Calculate moving average for fpop 

# Calculate moving average for fempar 

# Calculate moving average for unempl 

# Calculate moving average for turnout
```
